    ...
    return (
        <Card className="overflow-hidden">
            ...
            <CardContent className="grid gap-6 p-6">
                ...
                <motion.div
                    {...getRootProps()}
                    className={`relative flex items-center justify-center border-2 border-dashed rounded-lg p-8 transition-colors ${isDragActive ? "border-[#4285F4]" : "border-blue-200"
                        }`}
                    ...
                    <AnimatePresence mode="wait">
                        {!videoPreview ? (
                            ...
                            >
                                ...
                                <div className="text-blue-900 font-medium">Drag and drop your video here</div>
