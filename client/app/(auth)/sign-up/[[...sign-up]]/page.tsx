        ...
        <div className="w-full lg:grid lg:min-h-[600px] lg:grid-cols-2 xl:min-h-[800px]">
            <div className="flex items-center justify-center py-12">
                <div className="mx-auto w-[350px] space-y-6">
                    <Link href="/" className="inline-flex items-center text-sm text-[#3B82F6] hover:text-[#2563EB]">
                    ...
                    <SignUp
                        appearance={{
                            elements: {
                                formButtonPrimary: 'bg-gradient-to-r from-[#3B82F6] to-[#2563EB] text-white hover:from-[#2563EB] hover:to-[#1D4ED8] w-full',
                                formButtonSecondary: 'bg-[#F1F5F9] text-[#1E293B] hover:bg-[#E2E8F0] w-full',
                    ...
                    <div className="text-center text-sm text-[#475569]">
                        ...
                        <Link href="/sign-in" className="underline hover:text-[#3B82F6]">
                            Sign in
                        </Link>
                    </div>
                </div>
